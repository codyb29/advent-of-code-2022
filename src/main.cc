...
int main(int argc, char* argv[]) {
    ...
    switch (day) {
        ...
        case 2: {
            ...
            int score =
                DecryptStrategyGuideIncorrectly(encrypted_strategy_guide);
        ...
        case 3: {
            ...
            std::cout << "Sum of badges: "
                      << RucksackOrganization::SumOfBadges(rucksacks)
                      << std::endl;
        } break;
        case 4: {
            ...
            std::cout << "Completely Overlapping Pairs: "
                      << CleanCamp::CountOverlappingPairs(
                             assignments, CleanCamp::IsFullyOverlapping)
                      << std::endl;
        ...
        case 5: {
            ...
            std::cout << "On top of each stack for CrateMover 9000: "
                      << SupplyStacks::SimulateCrateMover9000(crates,
                                                              instructions)
                      << std::endl;
            std::cout << "On top of each stack for CrateMover 9001: "
                      << SupplyStacks::SimulateCrateMover9001(crates,
                                                              instructions)
                      << std::endl;
            break;
        }
        ...
        case 8: {
            ...
            std::cout << TreetopTreeHouse::CountTreesVisible(tree_heights)
                      << std::endl;
        ...
        case 10: {
            ...
            std::cout << "total: "
                      << CathodeRayTube::GetSignalStrength(puzzle_input)
                      << std::endl;
        ...
        case 11: {
            ...
            std::vector<Monkey> monkeys =
                MonkeyInTheMiddle::MakeMonkeys(puzzle_input);
            std::cout << MonkeyInTheMiddle::GetMonkeyBusinessLevelForRounds(
                             monkeys, 10000)
                      << std::endl;
            break;
        }
